...
static const char qt_meta_stringdata_Countdown[] = {
    "Countdown\0\0time_over_sig()\0rem_sec\0"
    "rem_sec_sig(int)\0reduce_rem_sec()\0"
};
...
void Countdown::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->time_over_sig(); break;
        case 1: _t->rem_sec_sig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->reduce_rem_sec(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Countdown::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Countdown::staticMetaObject = {
    { &QTimer::staticMetaObject, qt_meta_stringdata_Countdown,
      qt_meta_data_Countdown, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void Countdown::time_over_sig()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Countdown::rem_sec_sig(int _t1)
{
